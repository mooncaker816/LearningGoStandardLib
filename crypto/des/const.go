...
// [Min] 初始排序顺序，用来打乱64-bit的原始block数据
...
// bits.
// [Min] 原需求中用来把32-bit的right在轮函数中扩充为48-bit
// [Min] 但这里 des 包并没有使用这一方法
...
// from a 64-bit input.
// [Min] PC1，在生成子秘钥之前，
// [Min] 将64-bit的秘钥去掉校验位，再按一定顺序排序得到56-bit的有效秘钥
...
// the 56-bit input
// [Min] PC2，用于生成子秘钥，从56-bit中选取48-bit，并按一定顺序排序
...
// [Min] 生成子秘钥前，对左右各28-bit按轮次索引获取需要循环左移的比特位长
