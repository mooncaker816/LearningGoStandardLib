...
// [Min] 对事件为id的处理
// [Min] 当 id 和 p.id不相等时，会等到 id-1的 endRequest 向 id 的 wait channel发送消息，解除阻塞，从而真正处理 id 的 request
...
// been called.
// [Min] 阻塞事件 id 的处理，直至  id-1 事件的EndRequest 向 id 的 wait channel 发消息
